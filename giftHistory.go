...
func (giftHistory History) AddYear(playerKey string) History {
	return append(giftHistory, StructGiftPair{Givee: playerKey, Giver: playerKey})
}

// UpdateGiftHistory replaces a giftPair at a given giftYear
func (giftHistory History) UpdateGiftHistory(giftYear int, giftPair StructGiftPair) History {
