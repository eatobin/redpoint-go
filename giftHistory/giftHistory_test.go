...
var giftPairPtr = &GiftPair{Givee: "GeoHar", Giver: "JohLen"}
var giftHistory = GiftHistory{giftPairPtr}
var gotGHAY = AddYear("NewBee", giftHistory)

//var gotGHUGH = UpdateGiftHistory(0, GiftPair{Givee: "me", Giver: "you"}, giftHistory)
var giftHistoryExtended = GiftHistory{giftPairPtr, &GiftPair{Givee: "NewBee", Giver: "NewBee"}}
